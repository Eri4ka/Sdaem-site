...
export const apartmentsList = [
  ...
  },
  {
    id: 2,
    section_id: 1,
    title: '2-комн. апартаменты на Грушевке',
    price: '45.00',
    description:
      'Какое-то описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры',
    rooms: {
    ...
    square: 65,
    adress: 'Минск, б-р Мулявина, д. 47',
    metro: 'Грушевка',
    district: 'Кабаны',
    images: [
  ...
  },
  {
    id: 7,
    section_id: 1,
    title: '3-комн. апартаменты на Московсокм',
    price: '83.00',
    description:
      'Большая четырехкомнатная студия! Большая джкакузи на двоих, на теливизоре есть приложение Megogo, YouTube, Smart TV, сможете выбрать фильм по вкусу!) Цена зависит от количества проживающих, уточняйте, пожалуйста, по телефону! В пяти минутах ходьбы Минск-Арена,  рядом несколько супермаркетов и ТЦ "Мега"',
    rooms: {
    ...
    square: 59,
    adress: 'Минск, ул. Московская, д. 88',
    metro: 'Московское',
    district: 'Московский',
    images: [
      { short: room3, wide: room3Wide },
  ...
  },
  {
    ...
    square: 25,
    adress: 'Минск, б-р Мулявина, д. 11',
    metro: 'Киевское',
    district: 'Шабаны',
    images: [{ short: verticalImg, wide: verticalTall }],
    tag: 'Gold',
  ...
  },
  {
    ...
    square: 150,
    adress: 'Минск, б-р Мулявина, д. 73',
    metro: 'Грушевка',
    district: 'Шабаны',
    images: [{ short: room3, wide: room3Wide }],
    tag: 'Gold',
  ...
  },
  {
    id: 12,
    section_id: 1,
    title: '1-комн. апартаменты на Витебской',
    price: '25.00',
    description:
      'Какое-то описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры',
    rooms: {
    ...
    square: 150,
    adress: 'Минск, ул Витебская, д. 11',
    metro: 'Витебское',
    district: 'Витебский',
    images: [{ short: room3, wide: room2Wide }],
    tag: 'Gold',
  ...
  },
  {
    ...
    square: 150,
    adress: 'Минск, ул Витебская, д. 19',
    metro: 'Витебское',
    district: 'Витебский',
    images: [{ short: room3, wide: room2Wide }],
    tag: 'Gold',
  ...
  },
  {
    id: 14,
    section_id: 3,
    title: '3-комн. апартаменты на Амантая',
    price: '55.00',
    description:
      'Большая трехкомнатная квартира! Большая джкакузи на двоих, на теливизоре есть приложение Megogo, YouTube, Smart TV, сможете выбрать фильм по вкусу!) Цена зависит от количества проживающих, уточняйте, пожалуйста, по телефону! Рядом несколько супермаркетов и ТЦ "Планета" с котятами',
    rooms: {
      count: '3 комн.',
      type: '3 (2+1)',
    },
    square: 63,
    adress: 'Брест, ул Амантая, д. 101',
    metro: 'Петрушино',
    district: 'Колгуевский',
    images: [{ short: room3, wide: room2Wide }],
    tag: 'Gold',
    contacts: {
      image: boyPic,
  ...
  },
  {
    id: 15,
    section_id: 4,
    title: '2-комн. квартира на Котиковской',
    price: '35.00',
    description:
      'Котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики котики',
    rooms: {
      count: '2 комн.',
      type: '2 (1+1)',
    },
    square: 150,
    adress: 'Витебск, ул Котиков, д. 100',
    metro: 'Котиковское',
    district: 'Котиковский',
    images: [{ short: room3, wide: room2Wide }],
    tag: 'Gold',
    contacts: {
      image: boyPic,
  ...
  },
  {
    id: 16,
    section_id: 5,
    title: '1-комн. апартаменты на Московкой',
    price: '43.00',
    description:
      'Какое-то описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры, описание квартиры',
    rooms: {
  ...
  },
  {
    ...
    square: 88,
    adress: 'Могилев, ул Котиков, д. 100',
    metro: 'Нешуточное',
    district: '№13',
    images: [{ short: room3, wide: room2Wide }],
    tag: 'Gold',
