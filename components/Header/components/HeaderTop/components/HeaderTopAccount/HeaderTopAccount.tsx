...
const HeaderTopAccount: React.FC<HeaderTopAccountProps> = ({ login, photo, ...props }) => {
    ...
    <div className={styles['header-account']}>
      ...
      {toggle && (
        <ul className={`list ${styles['header-account__list']}`}>
          <li className={styles['header-account__item']}>
            <button className={styles['header-account__button']} {...props}>
              Выйти
            </button>
          </li>
        </ul>
