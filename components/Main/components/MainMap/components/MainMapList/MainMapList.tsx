...
import MoveIc from '@public/icons/main/map/move.svg';
import TargetIc from '@public/icons/main/map/target.svg';

import MainMapCard from '../MainMapCard';
...
export default memo(MainMapList);
